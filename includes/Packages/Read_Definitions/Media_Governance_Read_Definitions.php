				...
				'input_schema'     => array(
					...
					'properties'           => array(
						...
						'large_file_threshold_bytes' => array( 'type' => 'integer', 'minimum' => 102400, 'maximum' => 104857600, 'default' => 524288 ),
							...
							'optimization_mode'          => array( 'type' => 'string', 'enum' => array( 'manual', 'auto_safe' ), 'default' => 'manual' ),
							'optimization_profile'       => array( 'type' => 'string', 'enum' => array( 'manual', 'auto_safe.v1' ) ),
							'resize_mode'                => array( 'type' => 'string', 'enum' => array( 'preserve', 'fit' ), 'default' => 'preserve' ),
							'expected_source_media_fingerprint' => array( 'type' => 'string', 'pattern' => '^sha256:[0-9a-f]{64}$' ),
						'quality'                    => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 100, 'default' => 82 ),
						'crop'                       => array(
							'type'                 => 'object',
							'properties'           => array(
			...
			'npcink-abilities-toolkit/build-media-derivative-batch-plan' => array(
				...
				'input_schema'     => array(
					...
					'properties'           => array(
						...
						'date_from'                  => array( 'type' => 'string' ),
						'date_to'                    => array( 'type' => 'string' ),
							'optimization_mode'          => array( 'type' => 'string', 'enum' => array( 'auto_safe' ), 'default' => 'auto_safe' ),
							'optimization_profile'       => array( 'type' => 'string', 'enum' => array( 'auto_safe.v1' ), 'default' => 'auto_safe.v1' ),
							'image_types'                => array(
								'type'    => 'array',
								'default' => array( 'jpeg', 'png', 'webp' ),
								'items'   => array( 'type' => 'string', 'enum' => array( 'jpeg', 'png', 'webp' ) ),
							),
							'resize_mode'                => array( 'type' => 'string', 'enum' => array( 'preserve', 'fit' ), 'default' => 'preserve' ),
						'target_max_width'           => array( 'type' => 'integer', 'minimum' => 320, 'maximum' => 7680, 'default' => 1920 ),
						'large_file_threshold_bytes' => array( 'type' => 'integer', 'minimum' => 102400, 'maximum' => 104857600, 'default' => 524288 ),
							'max_items'                  => array( 'type' => 'integer', 'minimum' => 1, 'maximum' => 1000, 'default' => 1000 ),
							'page'                       => array( 'type' => 'integer', 'minimum' => 1, 'default' => 1 ),
					),
					'additionalProperties' => false,
				),
